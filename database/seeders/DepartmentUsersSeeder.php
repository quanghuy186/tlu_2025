...
class DepartmentUsersSeeder extends Seeder
{
    ...
    public function run()
    {
        $departmentUsers = [
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Kinh tế và quản lý
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Hóa và Môi trường
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Trung tâm Đào tạo quốc tế
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Kế toán và Kinh doanh
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Công trình (ID 41-44)
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Kỹ thuật tài nguyên nước (ID 45-47)
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Cơ khí (ID 48-51)
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Điện - Điện tử (ID 52-55)
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Công nghệ thông tin (ID 56-59)
            ...
            // Level 2 - Trưởng các Bộ môn thuộc Khoa Luật và Lý luận chính trị (ID 60-62)
        ...
        foreach ($departmentUsers as $user) {
            ...
            DB::table('user_has_roles')->insert([
                'user_id' => $user['id'],
                'role_id' => 3 // Role ID 3 - Giả sử là role cho lãnh đạo đơn vị
            ]);
        }
    }
}