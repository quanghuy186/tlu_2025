            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        <h5 class="card-title m-0 fw-bold text-primary">Thêm giảng viên mới</h5>
                        ...
                        <form action="{{ route('admin.teacher.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="p-3 border rounded bg-light mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="teacher_code" name="teacher_code" value="{{ old('teacher_code') }}">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="academic_rank" name="academic_rank">
                                            ...
                                            <option value="Giáo sư" {{ old('academic_rank') == 'Giáo sư' ? 'selected' : '' }}>Giáo sư</option>
                                            <option value="Phó giáo sư" {{ old('academic_rank') == 'Phó giáo sư' ? 'selected' : '' }}>Phó giáo sư</option>
                                            <option value="Tiến sĩ" {{ old('academic_rank') == 'Tiến sĩ' ? 'selected' : '' }}>Tiến sĩ</option>
                                            <option value="Thạc sĩ" {{ old('academic_rank') == 'Thạc sĩ' ? 'selected' : '' }}>Thạc sĩ</option>
                                            <option value="Cử nhân" {{ old('academic_rank') == 'Cử nhân' ? 'selected' : '' }}>Cử nhân</option>
                                        </select>
                                    </div>
                            ...
                            <div class="p-3 border rounded bg-light mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="office_location" name="office_location" value="{{ old('office_location') }}">
                                    </div>
                                    
                                    <div class="col-md-12 mb-3">
                                        <label for="office_hours" class="form-label">Giờ làm việc/tiếp sinh viên</label>
                                        <textarea class="form-control" id="office_hours" name="office_hours" rows="3" placeholder="Ví dụ: Thứ 2, 4, 6: 9h-11h30; Thứ 3, 5: 14h-16h30">{{ old('office_hours') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="bi bi-check-circle me-2"></i>Tạo giảng viên
                                </button>
