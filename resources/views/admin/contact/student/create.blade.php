            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        <h5 class="card-title m-0 fw-bold text-primary">Thông tin sinh viên mới</h5>
                        ...
                        <form action="{{ route('admin.student.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="p-3 border rounded bg-light mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="student_code" name="student_code" value="{{ old('student_code') }}">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="graduation_status" name="graduation_status">
                                            ...
                                            @foreach($graduationStatuses as $key => $value)
                                                <option value="{{ $key }}" {{ old('graduation_status', 'studying') == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="bi bi-check-circle me-2"></i>Tạo sinh viên
                                </button>
