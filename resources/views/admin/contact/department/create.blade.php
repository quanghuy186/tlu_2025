                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.department.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 mt-5">
                                ...
                                <p class="small text-muted">Hệ thống sẽ tự động tạo tài khoản quản lý cho đơn vị này</p>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-text">Email này sẽ được dùng làm tên đăng nhập cho tài khoản quản lý.</div>
                                    @error('manager_email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
