    ...
    <div class="col-lg-12">
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card revenue-card" style="border-left: 5px solid #ffb848;">
            <div class="card-body">
              <h5 class="card-title">Tài khoản chưa kích hoạt</h5>
        ...
        <div class="col-xxl-4 col-xl-12">
          <div class="card info-card customers-card" style="border-left: 5px solid #ff5a5a;">
            <div class="card-body">
              <h5 class="card-title">Tài khoản không hoạt động</h5>
              ...
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  ...
                  const chart = new ApexCharts(document.querySelector("#reportsChart"), {
                    ...
                    xaxis: {
                      type: 'category',        // Sử dụng loại 'category' thay vì 'datetime'
                      categories: dayLabels,    // Sử dụng nhãn ngày tạo sẵn
                      tickPlacement: 'on',      // Đặt tick trực tiếp trên các điểm dữ liệu
                      labels: {
                        style: {
                          fontSize: '12px'
                        }
                  ...
                  document.querySelectorAll('.btn[data-period]').forEach(btn => {
                    btn.addEventListener('click', function(e) {
                      ...
                      if (period === 'daily') {
                        // Update chart title
                        document.getElementById('chart-period-text').textContent = `/ Tháng ${currentMonth} năm ${currentYear}`;
                        ...
                        // Update chart title
                        document.getElementById('chart-period-text').textContent = `/ Năm ${currentYear}`;
