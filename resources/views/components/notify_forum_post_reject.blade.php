...
<body>
    ...
    <div class="content">
        ...
        <p>Chúng tôi rất tiếc thông báo rằng bài viết của bạn đã bị từ chối trên diễn đàn.</p>
        
        <div class="post-info">
            <h3>{{ $post->title }}</h3>
            <p><strong>Thời gian từ chối:</strong> {{ $post->approved_at->format('d/m/Y H:i') }}</p>
        </div>
